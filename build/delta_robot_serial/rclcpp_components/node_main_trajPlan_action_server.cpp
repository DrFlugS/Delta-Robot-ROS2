...
#define NODE_MAIN_LOGGER_NAME "trajPlan_action_server"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtrajPlan_actionServer.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<TrajectoryPlanServer>";
